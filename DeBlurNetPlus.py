...
class DBNImpl(nn.Module):
    ...
    def __init__(self, input_channels=15, output_channels=3):
        ...
        self.f2_P=conv(128, 128, kernel_size=3)
        ...
        self.f5_P= conv(256, 256, kernel_size=3)
        ...
        self.f8_P = conv(512, 512, kernel_size=3)
        ...
        self.f11_P = conv(256, 256, kernel_size=3)

        self.u2 = deconv(256, 128)
        self.s2 = nn.ReLU()
        self.f12 = conv(128, 128, kernel_size=3)
        self.f13 = conv(128, 128, kernel_size=3)
        self.f13_P = conv(128, 64, kernel_size=3)
    ...
    def forward(self, inputs):
        ...
        f10 = self.f10(f9)
        f11 = self.f11(f10)
        f11_P = self.f11_P(f11)

        u2 = self.u2(f11_P)
        s2 = self.s2(f2 + u2)
        f12 = self.f12(s2)
        f13 = self.f13(f12)
        f13_P = self.f13_P(f13)
