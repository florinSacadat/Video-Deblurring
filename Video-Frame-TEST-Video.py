...
if __name__ == '__main__':
    vid_link = '/home/student/Documents/DeepVideoDebluring/PingPong.mp4'
    format=1080
    if format==1080:
     converter = os.system(
        'ffmpeg -i '+vid_link+' -vf scale=-1:720 -c:v libx264 -crf 18 -preset veryslow -c:a copy '+vid_link[:-4]+"HD.mp4")
    ...
    Frames2Video.Frames2Video(result_dir,result_dir+"Result30fps.mp4")
